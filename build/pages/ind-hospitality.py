...
PAGE = {
    ...
    "priority": '0.75',
    "title": "IT Support for Hospitality Gold Coast | bcom ICT",
    "description": "IT support for Gold Coast hotels, venues and accommodation. Guest WiFi at scale, booking system uptime.",
