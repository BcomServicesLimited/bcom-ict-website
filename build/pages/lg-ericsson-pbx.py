...
FAQS = [   (   'Who services LG Ericsson phone systems on the Gold Coast?',
        'bcom ICT installs, programmes and maintains LG Ericsson PBX systems across the Gold Coast, covering LG Ericsson iPECS, including eMG80, eMG100 and UCP series. That includes extension '
        'changes, call flow programming, auto-attendant and voicemail configuration, fault diagnosis and parts sourcing. Call 07 3041 8993.'),
    ...
    (   'Can you still get parts?',
        'For the LG Ericsson platforms listed above, usually yes. Where a part is genuinely unobtainable we will tell you, because that is the point at which replacement stops being optional and '
...
PAGE = {
    ...
    "priority": '0.65',
    "title": 'LG Ericsson PBX Support Gold Coast — iPECS | bcom ICT',
    "description": 'LG Ericsson iPECS phone system installation, programming and support on the Gold Coast. Extension changes, call flows, fault diagnosis and honest advice on remaining life.',
    "hero_img": 'lg-ericsson-pbx-gold-coast-hero.webp',
    "hero_alt": 'A LG Ericsson iPECS phone system being programmed by bcom ICT on the Gold Coast',
    "h1": 'LG Ericsson phone systems, still supported',
    "lede": 'A working LG Ericsson system that nobody will program is a genuinely frustrating position. We service, programme and maintain them.',
    "actions": [("Get a quote", "/contact", "white"), ("Call 07 3041 8993", "tel:+61730418993", "onink")],
    "trust": ['iPECS supported', 'Programming & moves', 'Parts sourced', 'Honest replacement advice'],
    "crumbs": [('Services', '/services'), ('PBX Systems', '/pabx-phone-systems-gold-coast'), ('LG Ericsson PBX', '/lg-ericsson-pbx-gold-coast')],
    "faqs": FAQS,
    "reviewed": "August 2026",
    "body": svc_body(answer='bcom ICT installs, programmes and maintains LG Ericsson PBX phone systems across the Gold Coast, covering LG Ericsson iPECS, including eMG80, eMG100 and UCP series. Work includes extension adds and changes, call flow and hunt group programming, auto-attendant and voicemail configuration, fault diagnosis and parts sourcing. Call 07 3041 8993.',
                ...
                'cols': 2,
                'eyebrow': 'What we do',
                'h2': 'Working on LG Ericsson systems',
                'icon': False},
        {       'h2': 'Models we support',
                'ticks': [       '<strong>LG Ericsson iPECS, including eMG80, eMG100 and UCP '
                                 'series</strong>',
        ...
        {       'h2': 'Should you replace it?',
                'html': '<p style="max-width:68ch">iPECS is a capable platform that is rarely worth '
                        'replacing while it works. A lot of the replacement quotes we review for iPECS '
                        "sites are driven by who is available rather than by the system's condition.</p><p "
                        'style="max-width:68ch;margin-top:16px">Our honest position: if the platform still '
                        'does what your business needs and parts are obtainable, keeping it is usually the '
                        'cheaper answer and we will say so. Replacement becomes the right call when '
                        ...
                        'style="max-width:68ch;margin-top:16px">When that point arrives we will tell you, '
                        'and <a href="/voip-phone-system-installation-and-support-gold-coast">moving to '
                        'cloud VoIP</a> is a planned capital decision rather than a forced one. Before any '
                        'move we test whether your internet connection is actually ready for it.</p>'}])
            + faq_block(FAQS)
        ...
        ('Telecommunications Contractor', '/telecommunications-contractor-gold-coast')])
            + cta('Got a LG Ericsson system nobody will touch?', "Tell us the model. If it's on our list, you probably don't need the replacement you've been quoted."),
}
