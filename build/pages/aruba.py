...
PAGE = {
    ...
    "priority": '0.7',
    "title": "Aruba Instant On WiFi Gold Coast | bcom ICT",
    "description": "Aruba Instant On WiFi designed, supplied and installed across the Gold Coast — cloud-managed networks with guest separation and nothing to administer.",
