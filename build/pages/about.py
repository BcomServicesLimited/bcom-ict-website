...
<section class="section section--mist">
  <div class="wrap">
    ...
    {ticks([
      "<strong>We quote before we start.</strong> On-site jobs are a fixed call-out fee plus hourly increments, agreed up front. You never get an invoice for something you didn't approve.",
