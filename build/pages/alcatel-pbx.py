...
FAQS = [   (   'Who services Alcatel-Lucent phone systems on the Gold Coast?',
        'bcom ICT programmes, repairs and supports Alcatel-Lucent PBX systems across the Gold Coast, covering OXO Connect, OmniPCX Office and OmniPCX Enterprise, plus the current and legacy handset '
...
PAGE = {
    ...
    "lede": 'OXO Connect · OmniPCX · 8068s · ALE-400. A working system nobody will programme is a genuinely frustrating position — we service, programme and source parts for the lot.',
    ...
    "body": svc_body(answer='bcom ICT programmes, repairs and supports Alcatel-Lucent PBX phone systems across the Gold Coast, covering OXO Connect, OmniPCX Office and OmniPCX Enterprise, along with the current and legacy handset ranges. Work includes extension adds and changes, call flow and hunt group programming, voicemail and auto-attendant configuration, fault diagnosis and parts sourcing. Call 07 3041 8993.',
