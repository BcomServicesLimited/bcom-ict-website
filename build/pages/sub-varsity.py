...
FAQS = [   (   'Do you provide IT support in Varsity Lakes?',
    ...
    (   'Do you support businesses that only need occasional help?',
        'Yes. Ad-hoc support is $198 + GST per hour with no ongoing commitment, plus a $100 + GST call-out for on-site work. We will tell you honestly if a monthly managed arrangement is not worth '
        'it for you yet.')]
...
PAGE = {
    ...
    "description": 'IT support for Varsity Lakes businesses — the business park precinct, Bond University corridor, medical suites and growth-stage professional firms. Same-day attendance.',
...
<section class="section">
  <div class="wrap">
    ...
    <p style="margin-top:16px">Most faults are resolved remotely first at $198 + GST per hour with no
    call-out, against $298 + GST for a first hour on site. Given the distance we will tell you honestly on the
