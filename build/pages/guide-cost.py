...
FAQS = [   (   'How much does IT support cost on the Gold Coast?',
        'bcom ICT charges $190 + GST per hour ($209.00 inc GST) for business IT support, plus a $100 + GST call-out ($110.00 inc GST) for on-site attendance — a first hour on site is $290 + GST ($319.00 inc GST), or a fixed $252 inc GST '
        'booked online. A remote job of up to an hour is $150 + GST ($165 inc GST) and carries no call-out. Managed IT is a flat monthly fee calculated from your requirements and the services included, quoted after a free review.'),
    ...
    "body": svc_body(answer='Business IT support on the Gold Coast is typically charged either hourly or as a flat monthly managed fee. bcom ICT charges $190 + GST per hour ($209.00 inc GST), plus a $100 + GST call-out ($110.00 inc GST) for on-site attendance — so a first hour on site is $290 + GST ($319.00 inc GST), or a fixed $252 inc GST booked online. Remote support carries no call-out. Managed IT is a flat monthly fee calculated from business requirements and services included, quoted after a free review.',
        ...
        {       'h2': 'Our published rates',
                'html': '<div class="pricecard" style="max-width:none"><div class="grid grid--3" '
                        ...
                        '$209.00 inc GST</small></div></div><div><div class="from">$100 <small>+ GST '
                        'on-site call-out · $110.00 inc GST</small></div></div><div><div class="from">$290 '
