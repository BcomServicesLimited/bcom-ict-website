...
FAQS = [   (   'Who services Panasonic phone systems on the Gold Coast?',
        'bcom ICT installs, programmes and maintains Panasonic PBX systems across the Gold Coast, covering Panasonic KX-NS700, KX-NS1000, KX-TDA and KX-TDE. That includes extension changes, call '
        'flow programming, auto-attendant and voicemail configuration, fault diagnosis and parts sourcing. Call 07 3041 8993.'),
    ...
    (   'Can you still get parts?',
        'For the Panasonic platforms listed above, usually yes. Where a part is genuinely unobtainable we will tell you, because that is the point at which replacement stops being optional and '
...
PAGE = {
    ...
    "priority": '0.65',
    "title": 'Panasonic PBX Support Gold Coast — KX series | bcom ICT',
    "description": 'Panasonic KX series phone system installation, programming and support on the Gold Coast. Extension changes, call flows, fault diagnosis and honest advice on remaining life.',
    "hero_img": 'panasonic-pbx-gold-coast-hero.webp',
    "hero_alt": 'A Panasonic KX series phone system being programmed by bcom ICT on the Gold Coast',
    "h1": 'Panasonic phone systems, still supported',
    "lede": 'A working Panasonic system that nobody will program is a genuinely frustrating position. We service, programme and maintain them.',
    "actions": [("Get a quote", "/contact", "white"), ("Call 07 3041 8993", "tel:+61730418993", "onink")],
    "trust": ['KX series supported', 'Programming & moves', 'Parts sourced', 'Honest replacement advice'],
    "crumbs": [('Services', '/services'), ('PBX Systems', '/pabx-phone-systems-gold-coast'), ('Panasonic PBX', '/panasonic-pbx-gold-coast')],
    "faqs": FAQS,
    "reviewed": "August 2026",
    "body": svc_body(answer='bcom ICT installs, programmes and maintains Panasonic PBX phone systems across the Gold Coast, covering Panasonic KX-NS700, KX-NS1000, KX-TDA and KX-TDE. Work includes extension adds and changes, call flow and hunt group programming, auto-attendant and voicemail configuration, fault diagnosis and parts sourcing. Call 07 3041 8993.',
                ...
                'cols': 2,
                'eyebrow': 'What we do',
                'h2': 'Working on Panasonic systems',
                'icon': False},
        {       'h2': 'Models we support',
                'ticks': [       '<strong>Panasonic KX-NS700, KX-NS1000, KX-TDA and KX-TDE</strong>',
        ...
        {       'h2': 'Should you replace it?',
                'html': '<p style="max-width:68ch">Panasonic is the most widely installed legacy platform '
                        ...
                        'cloud-only.</p><p style="max-width:68ch;margin-top:16px">Our honest position: if '
                        'the platform still does what your business needs and parts are obtainable, '
                        'keeping it is usually the cheaper answer and we will say so. Replacement becomes '
                        'the right call when hardware is failing, when you need staff working from home, '
                        'when you are opening a second site, or when parts genuinely run out.</p><p '
        ...
        ('Telecommunications Contractor', '/telecommunications-contractor-gold-coast')])
            + cta('Got a Panasonic system nobody will touch?', "Tell us the model. If it's on our list, you probably don't need the replacement you've been quoted."),
}
