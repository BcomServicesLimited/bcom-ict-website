...
PAGE = {
    ...
    "title": "Microsoft Azure for Australian Business | bcom ICT Gold Coast",
    "description": "Azure deployment and support for Gold Coast businesses — hosted servers, Azure Virtual Desktop, backup and site recovery, Entra ID. Honest advice on when Azure is the wrong answer.",
