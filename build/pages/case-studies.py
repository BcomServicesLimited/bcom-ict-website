...
<section class="section">
  <div class="wrap">
    ...
    <div class="section-head" style="margin-top:64px">
      ...
      <p>Two new stores for a retail customer. Six parties in each tenancy, one scope document, both open on
      schedule. <a href="/retail-store-technology-fitout-case-study">Read the case study</a>.</p>
    </div>
