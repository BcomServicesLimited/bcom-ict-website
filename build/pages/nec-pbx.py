...
FAQS = [   (   'Who services NEC phone systems on the Gold Coast?',
        'bcom ICT programmes, repairs and supports NEC PBX systems across the Gold Coast, covering UNIVERGE SV9100, SL2100 and the earlier SV8100, Aspire and Xen platforms, plus the current and '
...
PAGE = {
    ...
    "lede": 'SV9100 · SL2100 · Xen Topaz · DT900. A working system nobody will programme is a genuinely frustrating position — we service, programme and source parts for the lot.',
    ...
    "body": svc_body(answer='bcom ICT programmes, repairs and supports NEC PBX phone systems across the Gold Coast, covering UNIVERGE SV9100, SL2100 and the earlier SV8100, Aspire and Xen platforms, along with the current and legacy handset ranges. Work includes extension adds and changes, call flow and hunt group programming, voicemail and auto-attendant configuration, fault diagnosis and parts sourcing. Call 07 3041 8993.',
