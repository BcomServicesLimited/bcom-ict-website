...
PRICING = [
    ('First hour on site, booked online', '$252', 'inc GST &middot; fixed price',
     [
      ...
      'The call-out is included rather than added on top',
...
PAGE = {
    ...
    "description": 'On-site IT support at your Gold Coast office. Workstations, servers, networks and connectivity faults fixed in person, same-day where available. $39 + GST call-out plus $190 + GST per hour.',
...
<section class="section section--tight">
  <div class="wrap">
    ...
    {price_table(PRICING, note='A first hour on site is $252 inc GST &mdash; the $39 + GST call-out and the $190 + GST hour as a single figure. Booking through the calendar simply settles it before anyone sets off; it is the same price if you ring us. Time past the first hour is charged at $190 + GST in half-hour increments, and if a job is clearly larger than a single visit we will say so before the hour is up rather than after it. Full rates are on the <a href="/pricing">pricing page</a>.')}
  </div>
</section>
'''
            + f'''
