...
FAQS = [
    ...
    ("Do you charge to quote?",
     "No. Quoting is free, and we quote before starting work rather than invoicing afterwards. Business IT support is $190 + GST per hour ($209.00 inc GST), with a $39 + GST call-out on on-site work. Remote support carries no call-out."),
