...
LINES = [
    ("Phone", f'<a href="{BIZ["phone_href"]}">{BIZ["phone"]}</a>',
     "Answered 24/7, including weekends and public holidays. After hours our AI operator takes the details and escalates."),
...
FAQS = [
    ("How do I contact bcom ICT?",
     "Call 07 3041 8993, email support@bcomservices.com, or use the enquiry form on this page. Phones are answered 24/7 including weekends and public holidays, and every enquiry receives a callback within 4 business hours. The office is at 9 Ferny Avenue, Surfers Paradise QLD 4217."),
    ("What happens after I get in touch?",
     "We call you back within 4 business hours to understand the problem. If it can be fixed remotely we'll often start there and then. If it needs someone on site, we book a visit — same day where we can — and tell you the call-out and hourly rate before anyone gets in a car."),
    ...
    ("Do you charge to quote?",
     "No. Quoting is free, and we quote before starting work rather than invoicing afterwards. On-site jobs are a fixed call-out fee plus hourly increments, agreed up front."),
    ("What if it's an emergency?",
     "Call rather than email. Phones are answered 24/7. If you think you've been breached, don't turn anything off or delete anything — see cyber incident response for what to do in the first hour."),
...
PAGE = {
    ...
    "description": "Contact bcom ICT on 07 3041 8993 or support@bcomservices.com. Phones answered 24/7, callback within 4 business hours. Office at 9 Ferny Avenue, Surfers Paradise.",
    "hero_kind": "doc",
    "eyebrow": "Contact",
    "h1": "Talk to someone who can actually help",
    "lede": "Phones answered 24/7. Callback within 4 business hours, every time. The first conversation and the systems review that follows are both free.",
...
<section class="section section--tight">
  <div class="wrap">
    ...
    answered 24/7 including weekends and public holidays, and every enquiry receives a callback within 4
    ...
    <div class="contact-grid" style="margin-top:56px">
      ...
      <form class="enquiry" action="https://formspree.io/f/{FORM_ENDPOINT}" method="POST">
        ...
        <p class="hint">We'll come back to you within 4 business hours. We don't share your details with anyone.</p>
      </form>
    </div>
  </div>
</section>
