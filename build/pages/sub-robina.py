...
<section class="section">
  <div class="wrap">
    ...
    <p style="margin-top:16px">Most faults are resolved remotely first — $198 + GST per hour with no call-out
    against $298 + GST for a first hour on site. Email, Microsoft 365, software, account and printer problems
